...
<div class="row" style='margin-left: 20px'>
	...
	<form action="/applications" method="POST">
	  ...
	  <div class="form-group">
		...
		<input type="text" class="form-control" id="name" name="name" aria-describedby="nameHelp" placeholder="Enter the name of the application" required>
	  ...
	  <div class="form-group">
		...
		<input type="text" class="form-control" id="home" name="home" aria-describedby="homeHelp" placeholder="What URL can you access this application at?" required>
	 ...
	 <div class="form-group">
		...
		<input type="text" class="form-control" id="callback_url" name="callback_url" aria-describedby="callbackHelp" placeholder="We need a URL to send data to your application. We call this URL a callback url. What is that URL?" required>
